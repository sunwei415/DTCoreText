...
- (unichar)characterAtIndex:(NSUInteger)index outOfRange:(unichar)outOfRangeValue;
{
...
- (NSString *)substringWithRange:(NSRange)range outOfRange:(NSString *)outOfRangeValue;
{
